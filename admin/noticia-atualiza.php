        ...
        <form class="mx-auto w-75" action="" method="post" id="form-atualizar" name="form-atualizar" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="categoria" id="categoria" required>
					...
					<option  <?php if($dados['categoria_id'] === $categoria['id']) echo " selected " ?>
						value="<?=$categoria['id']?>"> 
						<?=$categoria['nome']?> 
					</option>
					<?php } ?>
            ...
            <div class="mb-3">
                ...
                <textarea <?=$dados ['texto']?> class="form-control" required name="texto" id="texto" cols="50" rows="6"><?=$dados ['texto']?></textarea>
            </div>
